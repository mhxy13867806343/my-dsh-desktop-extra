...
function apply(ctx) {
  ...
  function buildBgCss(cfg, dark) {
    const veil = dark ? 'rgba(10,12,18,0.3)' : 'rgba(255,255,255,0.08)';
    const b = dark ? 'rgba(13,15,20,0.3)' : 'rgba(255,255,255,0.10)';
    const l1 = dark ? 'rgba(24,27,34,0.4)' : 'rgba(255,255,255,0.16)';
    const l2 = dark ? 'rgba(30,33,42,0.36)' : 'rgba(255,255,255,0.14)';
    const l3 = dark ? 'rgba(40,43,52,0.38)' : 'rgba(255,255,255,0.15)';
    const ov = dark ? 'rgba(24,27,34,0.48)' : 'rgba(255,255,255,0.20)';
    const menu = dark ? 'rgba(30,33,42,0.53)' : 'rgba(255,255,255,0.22)';
    const sb = dark ? 'rgba(13,15,20,0.38)' : 'rgba(255,255,255,0.16)';
    return 'html{background:transparent !important}' + 'body{background:transparent !important}' + '#root{background:transparent !important}' +
      '#root{--dsw-alias-bg-base:' + b + ' !important;--dsw-alias-bg-overlay:' + ov + ' !important;--dsw-specific-menu:' + menu + ' !important;--dsw-specific-sidebar-fill:' + sb + ' !important}' +
  ...
  ctx.effect(() => {
    const disposeStyles = insertCss(
      // 通用
      // 个人资料卡
      '.dshpBox{background:var(--dsw-alias-bg-module-platform);border:1px solid var(--dsw-alias-border-l2);border-radius:16px;padding:20px;margin:8px 0}' +
      '.dshpHead{display:flex;align-items:center;gap:14px;margin-bottom:16px}' +
      '.dshpAvatar{width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:600;color:#fff;flex:none}' +
      '.dshpName{font-size:16px;font-weight:500;color:var(--dsw-alias-label-primary);line-height:24px}' +
      '.dshpHandle{font-size:12px;color:var(--dsw-alias-label-tertiary);line-height:20px;margin-top:2px}' +
      '.dshpBadge{display:inline-flex;align-items:center;gap:4px;background:var(--dsw-alias-bg-module-float);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;padding:1px 8px;font-size:11px;color:var(--dsw-alias-label-secondary);margin-top:6px}' +
      '.dshpAct{flex:none;height:28px;padding:0 14px;border:0;border-radius:8px;background:#2f6bff;color:#fff;font-size:12px;font-family:inherit;cursor:pointer;margin-left:8px}' +
      '.dshpAct2{flex:none;height:28px;padding:0 14px;border:1px solid rgba(255,255,255,.2);border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary);font-size:12px;font-family:inherit;cursor:pointer}' +
      '.dshpStats{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}' +
      '.dshpStat{background:var(--dsw-alias-bg-module-float);border:1px solid var(--dsw-alias-border-l2);border-radius:12px;padding:12px 14px}' +
      '.dshpStatVal{font-size:18px;font-weight:600;color:var(--dsw-alias-label-primary);line-height:26px;font-variant-numeric:tabular-nums}' +
      '.dshpStatLbl{font-size:11px;color:var(--dsw-alias-label-tertiary);line-height:16px;margin-top:4px}' +
      '.dshpSec{margin-top:16px;padding-top:12px;border-top:1px solid var(--dsw-alias-border-l2)}' +
      '.dshpTitle{font-size:13px;font-weight:500;color:var(--dsw-alias-label-primary);margin-bottom:8px}' +
      '.dshpKeyRow{display:flex;align-items:center;gap:8px;font-family:var(--dsh-font-mono,monospace);font-size:12px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-float);border-radius:10px;padding:0 10px;height:34px;margin-bottom:6px}' +
      '.dshpKey{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}' +
      '.dshpToggle{flex:none;height:26px;padding:0 10px;border:0;border-radius:8px;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);cursor:pointer;font-size:12px;font-family:inherit}' +
      '.dshpPlug{display:inline-flex;align-items:center;gap:6px;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-float);border-radius:8px;padding:4px 10px;font-size:12px;color:var(--dsw-alias-label-secondary);margin:0 6px 6px 0}' +
      '.dshpErr{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}' +
      '.dshpEmpty{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}' +
